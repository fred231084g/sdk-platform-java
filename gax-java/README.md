...
```Groovy
compile 'com.google.api:gax:2.74.2',
  'com.google.api:gax-grpc:2.74.2'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.api" % "gax" % "2.74.2"
libraryDependencies += "com.google.api" % "gax-grpc" % "2.74.2"
```
